...
The analysis helps in understanding attendance consistency, identifying potential absenteeism patterns, and supporting data-driven decision making.
...
---
 ...
 📁 Project Structure
- `employee_behavior_analysis.ipynb` → Main analysis notebook
